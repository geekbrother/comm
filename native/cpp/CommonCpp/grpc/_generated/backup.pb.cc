...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 12, -1, sizeof(::backup::FullAuthenticationResponseData)},
  { 23, -1, sizeof(::backup::SimpleAuthenticationRequestData)},
  { 30, -1, sizeof(::backup::AuthenticationInformationData)},
  { 38, -1, sizeof(::backup::CreateNewBackupRequest)},
  { 47, -1, sizeof(::backup::CreateNewBackupResponse)},
  { 55, -1, sizeof(::backup::SendLogRequest)},
  { 62, -1, sizeof(::backup::RecoverBackupKeyRequest)},
  { 68, -1, sizeof(::backup::RecoverBackupKeyResponse)},
  { 77, -1, sizeof(::backup::PullBackupRequest)},
  { 83, -1, sizeof(::backup::PullBackupResponse)},
};
...
const char descriptor_table_protodef_backup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "AC\030\005 \001(\014H\000\022\016\n\006userID\030\006 \001(\tB\016\n\014requestByt"
  "es\"\323\001\n\036FullAuthenticationResponseData\022\"\n"
  "\030pakeRegistrationResponse\030\001 \001(\014H\000\022!\n\027pak"
  "eRegistrationSuccess\030\002 \001(\010H\000\022 \n\026pakeCred"
  "entialResponse\030\003 \001(\014H\000\022\027\n\rpakeServerMAC\030"
  "\004 \001(\014H\000\022\037\n\025walletRawMessageValid\030\005 \001(\010H\000"
  "B\016\n\014responseData\"C\n\037SimpleAuthentication"
  "RequestData\022\020\n\010backupID\030\001 \001(\t\022\016\n\006userID\030"
  "\002 \001(\t\"N\n\035AuthenticationInformationData\022\017"
  "\n\005nonce\030\001 \001(\014H\000\022\024\n\nrawMessage\030\002 \001(\014H\000B\006\n"
  "\004data\"\332\001\n\026CreateNewBackupRequest\022J\n\031auth"
  "enticationRequestData\030\001 \001(\0132%.backup.Ful"
  "lAuthenticationRequestDataH\000\022N\n\035authenti"
  "cationInformationData\030\002 \001(\0132%.backup.Aut"
  "henticationInformationDataH\000\022\034\n\022newCompa"
  "ctionChunk\030\003 \001(\014H\000B\006\n\004data\"\203\001\n\027CreateNew"
  "BackupResponse\022L\n\032authenticationResponse"
  "Data\030\001 \001(\0132&.backup.FullAuthenticationRe"
  "sponseDataH\000\022\022\n\010backupID\030\002 \001(\tH\000B\006\n\004data"
  "\"f\n\016SendLogRequest\022C\n\022authenticationData"
  "\030\001 \001(\0132\'.backup.SimpleAuthenticationRequ"
  "estData\022\017\n\007logData\030\002 \001(\014\"\\\n\027RecoverBacku"
  "pKeyRequest\022A\n\022authenticationData\030\001 \001(\0132"
  "%.backup.FullAuthenticationRequestData\"\324"
  "\001\n\030RecoverBackupKeyResponse\022L\n\032authentic"
  "ationResponseData\030\001 \001(\0132&.backup.FullAut"
  "henticationResponseDataH\000\022N\n\035authenticat"
  "ionInformationData\030\002 \001(\0132%.backup.Authen"
  "ticationInformationDataH\000\022\022\n\010backupID\030\003 "
  "\001(\tH\000B\006\n\004data\"X\n\021PullBackupRequest\022C\n\022au"
  "thenticationData\030\001 \001(\0132\'.backup.SimpleAu"
  "thenticationRequestData\"K\n\022PullBackupRes"
  "ponse\022\031\n\017compactionChunk\030\001 \001(\014H\000\022\022\n\010logC"
  "hunk\030\002 \001(\014H\000B\006\n\004data2\320\002\n\rBackupService\022X"
  "\n\017CreateNewBackup\022\036.backup.CreateNewBack"
  "upRequest\032\037.backup.CreateNewBackupRespon"
  "se\"\000(\0010\001\022=\n\007SendLog\022\026.backup.SendLogRequ"
  ...
  "quest\032\032.backup.PullBackupResponse\"\000(\0010\001b"
  "\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_backup_2eproto = {
  false, false, 1927, descriptor_table_protodef_backup_2eproto, "backup.proto", 
...
FullAuthenticationResponseData::FullAuthenticationResponseData(const FullAuthenticationResponseData& from)
  ...
  switch (from.responseData_case()) {
    ...
    case kWalletRawMessageValid: {
      _internal_set_walletrawmessagevalid(from._internal_walletrawmessagevalid());
      break;
    }
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 4:
        ...
        continue;
      // bool walletRawMessageValid = 5;
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 40)) {
          _internal_set_walletrawmessagevalid(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* FullAuthenticationResponseData::_InternalSerialize(
  ...
  // bool walletRawMessageValid = 5;
  if (_internal_has_walletrawmessagevalid()) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(5, this->_internal_walletrawmessagevalid(), target);
  }
