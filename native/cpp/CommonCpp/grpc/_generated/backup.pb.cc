...
constexpr NewBackupKeyEntropy::NewBackupKeyEntropy(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
  : _oneof_case_{}{}
struct NewBackupKeyEntropyDefaultTypeInternal {
  constexpr NewBackupKeyEntropyDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~NewBackupKeyEntropyDefaultTypeInternal() {}
  union {
    NewBackupKeyEntropy _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT NewBackupKeyEntropyDefaultTypeInternal _NewBackupKeyEntropy_default_instance_;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_backup_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::backup::NewBackupKeyEntropy, _internal_metadata_),
  ~0u,  // no _extensions_
  PROTOBUF_FIELD_OFFSET(::backup::NewBackupKeyEntropy, _oneof_case_[0]),
  ~0u,  // no _weak_field_map_
  ::PROTOBUF_NAMESPACE_ID::internal::kInvalidFieldOffsetTag,
  ::PROTOBUF_NAMESPACE_ID::internal::kInvalidFieldOffsetTag,
  PROTOBUF_FIELD_OFFSET(::backup::NewBackupKeyEntropy, data_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 11, -1, sizeof(::backup::PakeRegistrationRequestAndUserId)},
  ...
  { 65, -1, sizeof(::backup::NewBackupKeyEntropy)},
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::backup::_NewBackupKeyEntropy_default_instance_),
...
const char descriptor_table_protodef_backup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "tData\022T\n pakeRegistrationRequestAndUserI"
  "D\030\001 \001(\0132(.backup.PakeRegistrationRequest"
  "AndUserIdH\000\022 \n\026pakeRegistrationUpload\030\002 "
  ...
  "pakeClientMAC\030\005 \001(\014H\000B\006\n\004data\"S\n PakeReg"
  "istrationRequestAndUserId\022\016\n\006userID\030\001 \001("
  "\t\022\037\n\027pakeRegistrationRequest\030\002 \001(\014\"_\n\037Wa"
  ...
  "\001(\t\"D\n\023NewBackupKeyEntropy\022\017\n\005nonce\030\001 \001("
  "\014H\000\022\024\n\nrawMessage\030\002 \001(\014H\000B\006\n\004data\"\306\001\n\026Cr"
  "eateNewBackupRequest\022J\n\031authenticationRe"
  "questData\030\001 \001(\0132%.backup.FullAuthenticat"
  "ionRequestDataH\000\022:\n\023newBackupKeyEntropy\030"
  "\002 \001(\0132\033.backup.NewBackupKeyEntropyH\000\022\034\n\022"
  "newCompactionChunk\030\003 \001(\014H\000B\006\n\004data\"\233\001\n\027C"
  "reateNewBackupResponse\022L\n\032authentication"
  "ResponseData\030\001 \001(\0132&.backup.FullAuthenti"
  "cationResponseDataH\000\022\026\n\014entropyValid\030\002 \001"
  "(\010H\000\022\022\n\010backupID\030\003 \001(\tH\000B\006\n\004data\"f\n\016Send"
  "LogRequest\022C\n\022authenticationData\030\001 \001(\0132\'"
  ".backup.SimpleAuthenticationRequestData\022"
  "\017\n\007logData\030\002 \001(\014\"\\\n\027RecoverBackupKeyRequ"
  "est\022A\n\022authenticationData\030\001 \001(\0132%.backup"
  ".FullAuthenticationRequestData\"\253\001\n\030Recov"
  "erBackupKeyResponse\022L\n\032authenticationRes"
  "ponseData\030\001 \001(\0132&.backup.FullAuthenticat"
  "ionResponseDataH\000\022\017\n\005nonce\030\002 \001(\014H\000\022\024\n\nra"
  "wMessage\030\003 \001(\014H\000\022\022\n\010backupID\030\004 \001(\tH\000B\006\n\004"
  "data\"X\n\021PullBackupRequest\022C\n\022authenticat"
  "ionData\030\001 \001(\0132\'.backup.SimpleAuthenticat"
  "ionRequestData\"K\n\022PullBackupResponse\022\031\n\017"
  "compactionChunk\030\001 \001(\014H\000\022\022\n\010logChunk\030\002 \001("
  "\014H\000B\006\n\004data2\320\002\n\rBackupService\022X\n\017CreateN"
  "ewBackup\022\036.backup.CreateNewBackupRequest"
  "\032\037.backup.CreateNewBackupResponse\"\000(\0010\001\022"
  "=\n\007SendLog\022\026.backup.SendLogRequest\032\026.goo"
  "gle.protobuf.Empty\"\000(\001\022[\n\020RecoverBackupK"
  "ey\022\037.backup.RecoverBackupKeyRequest\032 .ba"
  "ckup.RecoverBackupKeyResponse\"\000(\0010\001\022I\n\nP"
  "ullBackup\022\031.backup.PullBackupRequest\032\032.b"
  "ackup.PullBackupResponse\"\000(\0010\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_backup_2eproto = {
  false, false, 2518, descriptor_table_protodef_backup_2eproto, "backup.proto", 
...
class NewBackupKeyEntropy::_Internal {
 public:
};

NewBackupKeyEntropy::NewBackupKeyEntropy(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:backup.NewBackupKeyEntropy)
}
NewBackupKeyEntropy::NewBackupKeyEntropy(const NewBackupKeyEntropy& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  clear_has_data();
  switch (from.data_case()) {
  ...
  // @@protoc_insertion_point(copy_constructor:backup.NewBackupKeyEntropy)
}

void NewBackupKeyEntropy::SharedCtor() {
clear_has_data();
}

NewBackupKeyEntropy::~NewBackupKeyEntropy() {
  // @@protoc_insertion_point(destructor:backup.NewBackupKeyEntropy)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void NewBackupKeyEntropy::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  if (has_data()) {
    clear_data();
  }
...
void NewBackupKeyEntropy::ArenaDtor(void* object) {
  NewBackupKeyEntropy* _this = reinterpret_cast< NewBackupKeyEntropy* >(object);
  (void)_this;
}
void NewBackupKeyEntropy::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void NewBackupKeyEntropy::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void NewBackupKeyEntropy::clear_data() {
// @@protoc_insertion_point(one_of_clear_start:backup.NewBackupKeyEntropy)
  switch (data_case()) {
    case kNonce: {
...
void NewBackupKeyEntropy::Clear() {
// @@protoc_insertion_point(message_clear_start:backup.NewBackupKeyEntropy)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* NewBackupKeyEntropy::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* NewBackupKeyEntropy::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:backup.NewBackupKeyEntropy)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:backup.NewBackupKeyEntropy)
  return target;
}

size_t NewBackupKeyEntropy::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:backup.NewBackupKeyEntropy)
  size_t total_size = 0;
...
void NewBackupKeyEntropy::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:backup.NewBackupKeyEntropy)
  GOOGLE_DCHECK_NE(&from, this);
  const NewBackupKeyEntropy* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<NewBackupKeyEntropy>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:backup.NewBackupKeyEntropy)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:backup.NewBackupKeyEntropy)
    MergeFrom(*source);
  }
}

void NewBackupKeyEntropy::MergeFrom(const NewBackupKeyEntropy& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:backup.NewBackupKeyEntropy)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void NewBackupKeyEntropy::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:backup.NewBackupKeyEntropy)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void NewBackupKeyEntropy::CopyFrom(const NewBackupKeyEntropy& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:backup.NewBackupKeyEntropy)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool NewBackupKeyEntropy::IsInitialized() const {
  return true;
}

void NewBackupKeyEntropy::InternalSwap(NewBackupKeyEntropy* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  swap(data_, other->data_);
  swap(_oneof_case_[0], other->_oneof_case_[0]);
...
::PROTOBUF_NAMESPACE_ID::Metadata NewBackupKeyEntropy::GetMetadata() const {
  return GetMetadataStatic();
}
...
class CreateNewBackupRequest::_Internal {
 public:
  ...
  static const ::backup::NewBackupKeyEntropy& newbackupkeyentropy(const CreateNewBackupRequest* msg);
};
...
const ::backup::NewBackupKeyEntropy&
CreateNewBackupRequest::_Internal::newbackupkeyentropy(const CreateNewBackupRequest* msg) {
  return *msg->data_.newbackupkeyentropy_;
}
...
void CreateNewBackupRequest::set_allocated_newbackupkeyentropy(::backup::NewBackupKeyEntropy* newbackupkeyentropy) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  clear_data();
  if (newbackupkeyentropy) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(newbackupkeyentropy);
    if (message_arena != submessage_arena) {
      newbackupkeyentropy = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, newbackupkeyentropy, submessage_arena);
    }
    set_has_newbackupkeyentropy();
    data_.newbackupkeyentropy_ = newbackupkeyentropy;
  }
  // @@protoc_insertion_point(field_set_allocated:backup.CreateNewBackupRequest.newBackupKeyEntropy)
}
...
CreateNewBackupRequest::CreateNewBackupRequest(const CreateNewBackupRequest& from)
  ...
  switch (from.data_case()) {
    ...
    case kNewBackupKeyEntropy: {
      _internal_mutable_newbackupkeyentropy()->::backup::NewBackupKeyEntropy::MergeFrom(from._internal_newbackupkeyentropy());
      break;
    }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ctx->ParseMessage(_internal_mutable_newbackupkeyentropy(), ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* CreateNewBackupRequest::_InternalSerialize(
  ...
  if (_internal_has_newbackupkeyentropy()) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(
        2, _Internal::newbackupkeyentropy(this), target, stream);
  }
...
template<> PROTOBUF_NOINLINE ::backup::NewBackupKeyEntropy* Arena::CreateMaybeMessage< ::backup::NewBackupKeyEntropy >(Arena* arena) {
  return Arena::CreateMessageInternal< ::backup::NewBackupKeyEntropy >(arena);
}
