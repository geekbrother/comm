...
class FullAuthenticationResponseData PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kWalletRawMessageValidFieldNumber = 5,
  };
  ...
  bool has_walletrawmessagevalid() const;
  private:
  bool _internal_has_walletrawmessagevalid() const;
  public:
  void clear_walletrawmessagevalid();
  bool walletrawmessagevalid() const;
  void set_walletrawmessagevalid(bool value);
  private:
  bool _internal_walletrawmessagevalid() const;
  void _internal_set_walletrawmessagevalid(bool value);
  public:
 ...
 private:
  ...
  void set_has_walletrawmessagevalid();
...
// bool walletRawMessageValid = 5;
inline bool FullAuthenticationResponseData::_internal_has_walletrawmessagevalid() const {
  return responseData_case() == kWalletRawMessageValid;
}
inline bool FullAuthenticationResponseData::has_walletrawmessagevalid() const {
  return _internal_has_walletrawmessagevalid();
}
inline void FullAuthenticationResponseData::set_has_walletrawmessagevalid() {
  _oneof_case_[0] = kWalletRawMessageValid;
}
inline void FullAuthenticationResponseData::clear_walletrawmessagevalid() {
  if (_internal_has_walletrawmessagevalid()) {
    responseData_.walletrawmessagevalid_ = false;
    clear_has_responseData();
  }
}
inline bool FullAuthenticationResponseData::_internal_walletrawmessagevalid() const {
  if (_internal_has_walletrawmessagevalid()) {
    return responseData_.walletrawmessagevalid_;
  }
  return false;
}
inline void FullAuthenticationResponseData::_internal_set_walletrawmessagevalid(bool value) {
  if (!_internal_has_walletrawmessagevalid()) {
    clear_responseData();
    set_has_walletrawmessagevalid();
  }
  responseData_.walletrawmessagevalid_ = value;
}
inline bool FullAuthenticationResponseData::walletrawmessagevalid() const {
  // @@protoc_insertion_point(field_get:backup.FullAuthenticationResponseData.walletRawMessageValid)
  return _internal_walletrawmessagevalid();
}
inline void FullAuthenticationResponseData::set_walletrawmessagevalid(bool value) {
  _internal_set_walletrawmessagevalid(value);
  // @@protoc_insertion_point(field_set:backup.FullAuthenticationResponseData.walletRawMessageValid)
}
