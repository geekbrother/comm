...
#ifndef CXXBRIDGE1_STRUCT_MessageState
#define CXXBRIDGE1_STRUCT_MessageState
struct MessageState final {
  ::rust::Vec<::std::uint8_t> message;
  ::rust::Vec<::std::uint8_t> state;

  using IsRelocatable = ::std::true_type;
};
#endif // CXXBRIDGE1_STRUCT_MessageState

#ifndef CXXBRIDGE1_STRUCT_MessageSession
#define CXXBRIDGE1_STRUCT_MessageSession
struct MessageSession final {
  ::rust::Vec<::std::uint8_t> message;
  ::rust::Vec<::std::uint8_t> session;

  using IsRelocatable = ::std::true_type;
};
#endif // CXXBRIDGE1_STRUCT_MessageSession

::MessageState client_register_cxx(::rust::String password);

::rust::Vec<::std::uint8_t> client_register_finish_cxx(
    ::rust::Vec<::std::uint8_t> client_register_state,
    ::rust::Vec<::std::uint8_t> server_message);

::MessageState client_login_cxx(::rust::String password);

::MessageSession client_login_finish_cxx(
