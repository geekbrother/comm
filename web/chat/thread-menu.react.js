...
function ThreadMenu(props: ThreadMenuProps): React.Node {
  ...
  const sidebarItem = React.useMemo(() => {
    ...
    return (
      <ThreadMenuItem
        ...
        text="Sidebars"
        icon={faArrowRight}
        onClick={() => setModal(<SidebarListModal threadInfo={threadInfo} />)}
      />
    );
  }, [hasSidebars, setModal, threadInfo]);
  ...
  const onClickLeaveThread = React.useCallback(
    ...
    [callLeaveThread, clearModal, dispatchActionPromise, setModal, threadInfo],
  );
