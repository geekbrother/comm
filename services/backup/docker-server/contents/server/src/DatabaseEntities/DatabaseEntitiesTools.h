 ...
 *               `logChildren` - list of log records that are children of this
 ...
 *    assigned to the latest backup's compaction item.
 ...
 *    - adds the newly added log id to compaction's `logChildren`
 *   returns
 *    - nothing(still a status automatically though)
 *  PullBackupKey
 *   receives
