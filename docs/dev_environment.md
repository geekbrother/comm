...
The second config file contains some details that server needs to launch olm sessions to provide E2E encryption.
...
At this moment E2E encryption with Olm is not used yet, so you can freely modify `privateKey` value.
