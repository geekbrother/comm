...
If you're using an Apple Silicon Mac, Homebrew will print the following lines that should be added to your desired shell configuration file:
...
Otherwise, for Intel Macs, Homebrew will print:
