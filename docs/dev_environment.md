...
The reason we need Python 2.7 on is because the `sqlite3` NPM package doesn't come with prebuilt ARM64 binaries and requires a native build that depends on Python 2 scripts.
